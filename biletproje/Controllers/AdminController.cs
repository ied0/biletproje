...
namespace biletproje.Controllers
{
	...
	{
		private readonly biletprojeDbContext _context;
		private readonly UserManager<IdentityUser> _userManager;
		private readonly SignInManager<IdentityUser> _signInManager;
		private readonly IPasswordHasher<IdentityUser> _passwordHasher;
		private readonly IEmailService _emailService;
		public AdminController(biletprojeDbContext context, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IPasswordHasher<IdentityUser> passwordHasher, IEmailService emailService)
		{
			_context = context;
